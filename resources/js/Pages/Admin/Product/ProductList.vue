...
const AddProduct = async () => {
    ...
    if (product_images.value){
        formData.append("product_image", product_images.value);
    }
...
<template>
    <section class="bg-gray-50 h-[100vh] dark:bg-gray-900 p-3 sm:p-5">
        ...
        <el-dialog v-model="dialogVisible" :title="editMode ? 'Edit Product' : 'Add Product'" width="30%"
            ...
            <form @submit.prevent="editMode ? updateProduct() : AddProduct()" class="max-w-md mx-auto">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input type="text" v-model="price" name="floating_price" id="floating_price"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " required />
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input type="number" v-model="quantity" name="qty" id="qty"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " required />
                ...
                <!-- <div class="flex flex-nowrap mb-8">
                    <div v-for="pimage in product_images" :key="pimage.id" class="relative w-32 h-32">
                        <img class="w-24 h-20 rounded-sm" :src="`/${pimage.image}`" alt="" />
                        <span
                ...
                <div
                    ...
                    <div
                        ...
                        <button type="button" @click="openAddModal"
                            class="flex items-center justify-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                            ...
                            <tr v-for="product in products" :key="product.id" class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 flex items-center justify-end">
                                    ...
                                    <div :id="`${product.id}-dropdown`"
                                        ...
                                        <div class="py-1">
                                            <a @click="deleteProduct(product, index)" href="#"
